...
public class UserDaoImpl implements UserDao {
	...
	public void register(User user) {
		...
		String sql = "insert into users (username, password, firstname, lastname, email, address, phone, active, register_date) values(?,?,?,?,?,?,?,?,?)";
		jdbcTemplate.update(sql, new Object[] { user.getUsername(), user.getPassword(), user.getFirstname(),
				user.getLastname(), user.getEmail(), user.getAddress(), user.getPhone(), active, now });
	}
